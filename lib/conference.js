...
// Static lookup: FreeSWITCH conference action → {eventName, handlerName}
// Update this map if FreeSWITCH adds new conference::maintenance actions
// or if new _on* handler methods are added to this class.
 ...
 * a reference to the Conference object
   ...
   */
  play(file, callback) {
    assert.ok('string' === typeof file || Array.isArray(file),
