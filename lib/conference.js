...
Conference.prototype.onPlayFile = function(evt) {
  debug('conference-level play has started: ' , _.pick( evt.headers, ['File','Conference-Name']) ) ;
} ;
...
Conference.prototype.onPlayFileDone = function(evt) {
  debug('conference-level play has completed: ' , _.pick( evt.headers, ['seconds', 'milliseconds','samples','File','Conference-Name']) ) ;
} ;
