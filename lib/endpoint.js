...
class Endpoint extends Emitter {
   ...
   * @param  {ConferenceConnection~mediaOperationCallback} [callback] - callback invoked when operation completes
   * @return {[Promise|ConferenceConnection]} returns a Promise if no callback supplied; otherwise
