...
class Endpoint extends Emitter {
  constructor(conn, dialog, ms, opts) {
    ...
    this.conn.on(`esl::event::SWITCH_EVENT_PLAYBACK_START::${this.uuid}`, this._onPlaybackStart.bind(this)) ;
    this.conn.on(`esl::event::SWITCH_EVENT_PLAYBACK_STOP::${this.uuid}`, this._onPlaybackStop.bind(this)) ;
