...
class Endpoint extends Emitter {
  constructor(conn, dialog, ms, opts) {
    ...
    /**
     * we can shave some time off by pre-filling these two data elements and emitting 'ready'
     * here rather than waiting till we get stats back from freeswitch
     */
    this.local.sdp = dialog.remote.sdp;
    this.remote.sdp = dialog.local.sdp;
    this.sip.callId = dialog.sip.callId;
